package com.lei.muitdatasourcedruid.dynamic.datasource.toolkit;
...
public class DataSourceFactory {
	 ...
	 * @return 数据源
	 */
	public static DataSource createDataSource(DynamicDataSourceProperty dataSourceProperty) {
	...
	public static DataSource createBasicDataSource(DynamicDataSourceProperty dataSourceProperty) {
		try {
	...
	public static DataSource createDruidDataSource(DynamicDataSourceProperty dataSourceProperty) {
